...
for trN = 1:numTrial
    ...
    S2 = ati_15514_read( 'C:\Users\SyMonUser\Documents\Diar_Code\Matlab_Code\CentreOfPressure_Diar\ATI_Calib_Files\FT15575.cal');
    ...
    %% Save data
    fnum = trN;
    cd('C:\Users\SyMonUser\Documents\Diar_Code\Matlab_Code\CentreOfPressure_Diar')
    ...
    save(savefnum,'D','time','raw_force_voltage') %,'pairOrder','placementOrder')
